...
ExternalService.oauth1._requestTokens = {};

// connect middleware
ExternalService.oauth1._handleRequest = function (service, query, res) {
  ...
  var urls = ExternalService[service.serviceName]._urls;
  ...
  if (query.requestTokenAndRedirect) {
    ...
    ExternalService.oauth1._requestTokens[query.state] = oauthBinding.requestToken;
    ...
    var requestToken = ExternalService.oauth1._requestTokens[query.state];
    delete ExternalService.oauth1._requestTokens[query.state];
